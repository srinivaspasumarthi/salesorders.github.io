...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(local, router) {
        this.local = local;
        this.router = router;
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(fb, router, dataservice) {
        this.fb = fb;
        this.router = router;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        console.log(this.fmdetails.value);
        this.dataservice.maxOrderNumber().subscribe(function (success) {
            console.log(success);
            _this.max_order_number = success.data[0].max_order_number + 1;
            _this.fmdetails.patchValue({
                order_number: _this.max_order_number
            });
            ...
            console.log(_this.fmdetails.controls);
            console.log(_this.fmdetails.value);
        }, function (error) {
            console.log(error);
        });
    };
    Object.defineProperty(HeaderComponent.prototype, "formdata", {
        get: function () { return this.fmdetails.controls; },
        enumerable: true,
        configurable: true
    });
    HeaderComponent.prototype.submitheader = function () {
        var _this = this;
        ...
        this.dataservice.header(this.headerData).subscribe(function (success) {
            console.log(success);
            _this.fmdetails.disable();
            _this.changeMessageHeader();
            _this.headerSaved = true;
            _this.router.navigate(['/dashboard/header/lines']);
    ...
    HeaderComponent.prototype.clearform = function () {
    ...
    HeaderComponent.prototype.changeMessageHeader = function () {
...
var LinedataService = /** @class */ (function () {
    function LinedataService(dataservice) {
        this.dataservice = dataservice;
    }
    LinedataService.prototype.resolve = function (route, state) {
        console.log(this.dataservice.getLines(route.params.id));
        return this.dataservice.getLines(route.params.id);
    };
    LinedataService.ctorParameters = function () { return [
...
var LinesComponent = /** @class */ (function () {
    function LinesComponent(dataService) {
        this.dataService = dataService;
    ...
    LinesComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.currentMessage.subscribe(function (message) { return _this.localordernumber = message; });
    ...
    LinesComponent.prototype.displayform = function () {
        this.formShow = true;
        var countRec = this.data.length;
        this.formData.id = countRec + 1;
    };
    LinesComponent.prototype.addDataToLines = function (data) {
        console.log('Data passed to lines');
        console.log(data);
    };
    LinesComponent.prototype.addData = function () {
    ...
    LinesComponent.prototype.addLines = function () {
    ...
    LinesComponent.prototype.saveLines = function () {
        console.log(this.LineData);
        if (this.LineData.length == 0) {
            alert('Please add lines.');
            return;
        }
        this.dataService.linesInsert(this.LineData).subscribe(function (success) {
            console.log(success);
    ...
    LinesComponent.ctorParameters = function () { return [
        { type: _data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
    ]; };
...
var OrdereditComponent = /** @class */ (function () {
    function OrdereditComponent(route, dataservice, linedataservice) {
        var _this = this;
        this.route = route;
        this.dataservice = dataservice;
        ...
        this.route.data.subscribe(function (success) {
            ...
            _this.headerObj = success.orderdata.data[0];
        });
        this.route.data.subscribe(function (success) {
            console.log(success);
            console.log(success.linedata.data);
            _this.lineobjects = success.linedata.data;
        });
    ...
    OrdereditComponent.prototype.updateHeaderData = function () {
        var _this = this;
        console.log('In update header data');
        this.headerReadonly = true;
        console.log(this.headerObj);
        this.dataservice.updateHeader(this.headerObj).subscribe(function (success) {
            console.log(success);
            _this.headerSaved = true;
        }, function (error) {
            console.log(error);
    ...
    OrdereditComponent.prototype.updateLine = function (row) {
        console.log('In updateLine');
        console.dir(row);
        this.dataservice.updateLine(row).subscribe(function (success) {
            console.log(success);
        }, function (error) {
            console.log(error);
        });
    };
    OrdereditComponent.prototype.updateLines = function () {
        this.lineReadonly = true;
        console.log('In update lines');
        console.log(this.lineobjects);
        this.dataservice.updateLines(this.lineobjects).subscribe(function (success) {
            console.log(success);
        }, function (error) {
            console.log(error);
        });
...
var ViewComponent = /** @class */ (function () {
    function ViewComponent(dataservice, router) {
        var _this = this;
        this.dataservice = dataservice;
        this.router = router;
        this.dataservice.getHeaders().subscribe(function (success) {
            console.log(success);
            _this.headers = success.data;
            console.log(_this.headers);
        }, function (error) {
            console.log(error);
        });
    }
    ViewComponent.prototype.deleteOrder = function (header) {
        var _this = this;
        console.log(header.order_number);
        var orderobjs = this.headers;
        console.log(orderobjs);
        console.log(this.headers);
        this.dataservice.deleteOrder(header.order_number).subscribe(function (success) {
            console.log(success);
            for (var i = 0; i < _this.headers.length; i++) {
                if (_this.headers[i].order_number == header.order_number) {
                    _this.headers.splice(i, 1);
                    console.log(_this.headers[i].order_number);
                }
            }
            console.log(_this.headers);
