...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.resolve = function (route, state) {
        ...
        this.getHeader(route.params.id).subscribe(function (success) {
            console.log(success);
            if (success.data.length == 0) {
                alert('Order ' + route.params.id + ' does not exist');
                _this.router.navigate(['/dashboard/view']);
            }
        }, function (error) {
            alert('Order ' + route.params.id + ' does not exist');
            _this.router.navigate(['/dashboard/view']);
    ...
    DataService.prototype.registration = function (data) {
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var ngx_localstorage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-localstorage */ "./node_modules/ngx-localstorage/fesm5/ngx-localstorage.js");
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(dataservice, router, local) {
    ...
    HomeComponent.prototype.login = function () {
        var _this = this;
        this.dataservice.login(this.loginData).subscribe(function (success) {
            console.log(success);
            if (success.response == 0) {
                ...
                _this.local.set('username', _this.loginData.username);
                _this.local.set('password', _this.loginData.password);
    ...
    HomeComponent.prototype.registration = function () {
        ...
        this.dataservice.registration(this.data).subscribe(function (success) {
            console.log(success);
        }, function (error) {
            console.log(error);
        });
...
var LogincheckService = /** @class */ (function () {
    function LogincheckService(local, router) {
        this.local = local;
        this.router = router;
    }
    LogincheckService.prototype.canActivate = function () {
    ...
    LogincheckService.ctorParameters = function () { return [
